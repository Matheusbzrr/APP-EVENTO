...
class LikeRoutes {
  ...
  initializeRoutes() {
     ...
     *     tags:
     *       - Likes
     *     summary: Deletar um like
     *     description: Endpoint para deletar um like do sistema pelo ID.
     *     parameters:
     *       - in: path
     *         name: idLike
     *         required: true
     *         schema:
     *           type: number
     *         description: ID do like a ser deletado.
     *         example: 1
     *     responses:
     *       204:
     ...
     *       500:
     *         description: Erro ao tentar deletar o like.
     */
    this.router.delete("/likes/:idLike", this.controller.delete);
